...
2. IN build/surefire plugin configuration section: ADD argLine tag with path to aspectj weaver jar,
   ...
   IN reporting section: ADD allure-maven artifact with <excludeDefaults> set to true. (Site goal now includes
   generation of Allure reports)
3. ADD allure.properties file to test/resources; list Allure properties like report directory there.
