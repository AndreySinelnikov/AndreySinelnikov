...
public final class WebDriverFactory {
    ...
    public static WebDriver createWebDriver(final String driverType, String browserName) {
    ...
    private static WebDriver createRemoteWebDriver(final String browserName) {
        ...
        try {
            return new RemoteWebDriver(new URL("http://192.168.1.109:4444/wd/hub"), capabilities);
